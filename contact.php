...
<!--	Title
	=========================================================-->
	<title>Real Estate Al-Manzil</title>
</head>
<body>
                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">UAE Abu Dhabi Central</span> <br>
										<span class="text-white">Al Ain (Eastern Region)</span>
										<span class="text-white">Al Gharbia (Western Region)
</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="d-table text-white">+971 123-456-7891</span>
										<span class="text-white">+971 123-456-7891 </span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Adderss</h5>
										<span class="d-table text-white">helpline@almaznsil.com</span>
										<span class="text-white">helpline@almaznsil.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
